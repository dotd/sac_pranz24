...
class StationaryHopperWindVelWrapper(Wrapper):
    ...
    def __init__(self,
        ...
        super(StationaryHopperWindVelWrapper, self).__init__(env)
        ...
        self.task_space = spaces.Box(
            low=np.array([config.env.low_target_vel, config.env.low_wind_frc], dtype=np.float32),
