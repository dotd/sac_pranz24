...
def main():
    ...
    state_projection_mat = np.random.normal(size=(obs_dim + action_dim, embeddings_dim))
    ...
    obs_acts_0 = np.concatenate([obs_0, actions_0])
    obs_acts_1 = np.concatenate([obs_1, actions_1])

    latent_obs_0 = np.concatenate([curr_obs @ state_projection_mat for curr_obs in obs_acts_0], axis=0)
    latent_obs_1 = np.concatenate([curr_obs @ state_projection_mat for curr_obs in obs_acts_1], axis=0)
