...
from simplified_vae.env.fixed_abs_env import FixedSingleWheelEnv
...
def parse_args():
    ...
    parser.add_argument('--seed', type=int, default=73, metavar='N',
...
def run_agent_and_environment(arguments):
    ...
    writer = SummaryWriter(
        'runs/{}_SAC_ABS{}_{}_{}'.format(datetime.datetime.now().strftime("%Y-%m-%d_%H-%M-%S"), arguments.env_name,
